...
(function () {
    ...
    */
    ...
    AjaxUpload.prototype = {
         ...
         * @return {Element} form
         */
        _createForm: function(iframe, method){
            ...
            var form = toElement('<form method="'+method+'" enctype="multipart/form-data"></form>');
        ...
        submit: function(){       
            ...
            var form = this._createForm(iframe, settings.method);
